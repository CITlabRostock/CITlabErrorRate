...
class CCWordDel extends CCAbstract {

    public CCWordDel(Voter voter) {
        super(voter);
    }
    ...
    public PathCalculatorGraph.DistanceSmall getNeighbourSmall(final int[] point, final PathCalculatorGraph.DistanceSmall dist) {
        ...
        return new PathCalculatorGraph.DistanceSmall(point, next, isSpaceReco[y] ? dist.costsAcc : dist.costsAcc + offsetDel, this);
    }
    ...
    public PathCalculatorGraph.IDistance<String, String> getNeighbour(PathCalculatorGraph.DistanceSmall dist) {
        ...
        return new DistanceStrStr(DistanceStrStr.TYPE.DEL, isSpaceReco[dist.point[0]] ? 0 : offsetDel, dist.costsAcc, part, null, dist.pointPrevious, dist.point);
    }
}
